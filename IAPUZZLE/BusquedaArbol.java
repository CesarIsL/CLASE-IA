...
public class BusquedaArbol {
    ...
    public void buscarSolucionProfundidadIterativa() {
        ...
        while (true) {
            ...
            boolean solucionEncontrada = buscarProfundidadConLimite(limite);
    ...
    public boolean buscarProfundidadConLimite(int limite) {
    ...
    public void buscarSolucionCostoUniforme() {
        ...
        while (!queue.isEmpty()) {
            ...
            if (estadoFinal.equals(estadoActual)) {
                imprimirCamino(currentNode);
                System.out.println("Iteraciones Costo Uniforme: " + iteraciones);
                return;
            }
